...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'resnet_9blocks':
        ...
        net = ResnetAttentionGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    else:
...
class ResnetAttentionGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=9):
        ...
        for i in range(n_blocks):
            model += [ResnetBlock(ngf * mult, norm_layer=norm_layer, use_dropout=use_dropout, use_attention=True)]
